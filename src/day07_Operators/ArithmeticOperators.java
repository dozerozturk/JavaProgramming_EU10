...
public class ArithmeticOperators {
    public static void main(String[] args) {
        ...
        int division= num1/num2; //10/3 division variable contains the result of num1 divided by num2
        int remainder = num1%num2; //10%3 remainder variable contains the remainder of num1 divided by number
